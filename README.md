...
This project was created to support [my article](https://eduardowronscki.hashnode.dev/graphql-api-with-nextjs) explaining how to setup a graphQL API with Next.js.
